...
function createPerson() {
	...
	/******************************edit person***********************************/
		...
		$('#personTableid tr:eq('+row_index+') td:eq(0)').html("<input type='hidden' id='personnametxt' name='personnametxt' value="+personname+">"+personname);
		$('#personTableid tr:eq('+row_index+') td:eq(1)').html("<input type='hidden' id='designationtxt' name='designationtxt' value="+designation+">"+designation);
		$('#personTableid tr:eq('+row_index+') td:eq(2)').html("<input type='hidden' id='contactnumbertxt' name='contactnumbertxt' value="+contactnumber+">"+contactnumber);
...
function addPerson(personid, personname, designation, contactnumber) {
	...
	str += "<tr>"
			...
			+ personname
			+ " "
			+ createHiddenFiled("personidtxt", personid)
			+ createHiddenFiled("personnametxt", personname)
			+ "</td>"
			+ "<td>"
			+ designation
			+ " "
			+ createHiddenFiled("designationtxt", designation)
			+ " </td>"
			+ "<td>"
			+ contactnumber
			+ "  "
			+ createHiddenFiled("contactnumbertxt", contactnumber)
			+ "</td>"
...
function editPerson(thiss) {
	...
	//var personnametxt = $(thiisss).closest('tr').find('input[id=personnametxt]').val();
	//var designationtxt = $(thiisss).closest('tr').find('#designationtxt').val();
	//var contactnumbertxt = $(thiisss).closest('tr').find('#contactnumbertxt').val();	
 	//$("#personid").val(row_index)
...
function createHiddenFiled(idName, value) {
	var str = "<input type ='hidden' id = '" + idName + "' name ='" + idName
			+ "' value ='" + value + "'>";
	return str;
}
