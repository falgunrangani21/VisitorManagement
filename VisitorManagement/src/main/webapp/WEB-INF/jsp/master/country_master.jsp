                            ...
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        <li>
                                            <a onclick="openmodal()" class="show-add-detail-form btn btn-primary btn-min-width box-shadow-1 mr-1 mb-1 text-white"><i class="fa fa-plus mr-1"></i> Add Country</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <a data-action="collapse">
                                    <h4 class="card-title">Add Country Details</h4>
                                </a>
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        <li>
                                            <a class="show-details-table btn btn-primary btn-min-width box-shadow-1 mr-1 mb-1 text-white"><i class="fa fa-undo mr-1"></i>  Move Back</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-content collapse show" id="countrydata">
                                <div class="card-body">
                                   <form class="form" name="countrymaster" id="countrymaster">
                                    <input type="hidden" name="countryid" id="countryid">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                	<div class="form-group">
                                                        <label for="projectinput3">Enter Country Name</label>
                                                       <input type="text" name="countryname" id="countryname" class="form-control" placeholder="Enter Country Name" maxlength="64" oninput="inputchar(this)">
                                                    </div>
                                  
                                                </div>
                                                 <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput3">ISD code</label>
                                                       <input type="text" name="isdcode" id="isdcode" class="form-control" placeholder="Enter ISD Code" maxlength="3" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(.*)\./g,'$1');">
                                                    </div>
                                                </div>
                                            </div>
...
<script src="jspJs/master/countrymaster.js"  type="text/javascript"></script>
</body>
