!function (e, t, o) {
    "use strict";
    var a = t.getElementById("btc-chartjs").getContext("2d");
    (i = a.createLinearGradient(0, 0, 0, 100)).addColorStop(0, "rgba(255, 145, 73,0.4)"), i.addColorStop(1, "rgba(255,255,255,0)");
    new Chart(a, {
        type: "line",
        options: {
            responsive: !0,
            ...
            legend: {display: !1},
            hover: {mode: "label"},
            scales: {xAxes: [{display: !1}], yAxes: [{display: !1, ticks: {min: 0, max: 85}}]},
            title: {display: !1, fontColor: "#FFF", fullWidth: !1, fontSize: 30, text: "52%"}
        },
        data: {
    ...
    var r = t.getElementById("eth-chartjs").getContext("2d");
    (i = r.createLinearGradient(0, 0, 0, 100)).addColorStop(0, "rgba(120, 144, 156,0.4)"), i.addColorStop(1, "rgba(255,255,255,0)");
    new Chart(r, {
        type: "line",
        options: {
            responsive: !0,
    ...
    var i, l = t.getElementById("xrp-chartjs").getContext("2d");
    (i = l.createLinearGradient(0, 0, 0, 100)).addColorStop(0, "rgba(30,159,242,0.4)"), i.addColorStop(1, "rgba(255,255,255,0)");
    new Chart(l, {
        type: "line",
        options: {
            responsive: !0,
    ...
    require.config({paths: {echarts: "../../../app-assets/vendors/js/charts/echarts"}}), require(["echarts", "echarts/chart/line", "echarts/chart/scatter", "echarts/chart/k"], function (e) {
        var t = e.init(document.getElementById("btc-candlestick-control"));
        chartOptions = {
            legend: {show: !1},
            grid: {x: 40, x2: 0, borderColor: "#e3e3e3"},
            tooltip: {
                ...
                }, axisPointer: {type: "line", lineStyle: {color: "#1E9FF2", width: 2, type: "solid"}}
            },
            legend: {show: !1, data: ["BTC"]},
            dataZoom: {show: !0, realtime: !0, start: 0, end: 50},
            ...
            yAxis: [{
                ...
                boundaryGap: [.01, .01],
                axisLine: {lineStyle: {color: "#fff"}},
                splitLine: {lineStyle: {color: "#e3e3e3"}}
            }],
            series: [{
                name: "BTC",
                type: "k",
                ...
                itemStyle: {
                    normal: {
                        color: "#94E8CA",
                        color0: "#FFA4B0",
                        lineStyle: {width: 2, color: "#28D094", color0: "#FF4961"}
                    }, emphasis: {color: "#28D094", color0: "#FF4961"}
                },
                data: [{
                    value: [2320.26, 2302.6, 2287.3, 2362.94],
                    itemStyle: {
                        normal: {color0: "#FFA4B0", lineStyle: {width: 3, color0: "#FF4961"}},
                        emphasis: {color0: "#FF4961"}
                    }
                ...
                markPoint: {
                    ...
                    data: [{name: "highest", value: 2444.8, xAxis: "2017/2/18", yAxis: 2466}]
                }
            }]
        }, t.setOption(chartOptions), $(function () {
            function e() {
                setTimeout(function () {
                    t.resize()
                }, 200)
